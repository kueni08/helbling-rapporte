...
function runMigrations(db) {
  ...
  try { db.exec("ALTER TABLE customer_inquiries ADD COLUMN updated_at TEXT DEFAULT (datetime('now'))"); } catch(e) {}

  // updated_at für articles (wird in lieferschein-watcher verwendet)
  try { db.exec("ALTER TABLE articles ADD COLUMN updated_at TEXT DEFAULT (datetime('now'))"); } catch(e) {}
